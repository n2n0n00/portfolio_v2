  ...
  return (
    <div className="m-20 pt-[20%]">
      <div className="flex flex-col items-center w-full">
        ...
        <h1 className="h1 text-white">Available services that I can work on</h1>
      </div>
      ...
      <div className="flex flex-col gap-10">
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-row justify-end">
            {" "}
            <p className="p_reg gray_text w-[50%]">
          ...
          <div className="flex flex-row w-full justify-center h-[120px]">
            <div className="trans_btn w-1/5">
